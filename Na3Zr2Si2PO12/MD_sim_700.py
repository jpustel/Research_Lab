...
parameters = MolecularDynamics(
    ...
    timestep=2, # 1fs,
    trajectory="Research_Lab/Na3Zr2Si2PO12/trajectories/mo.traj" + str(t),  # save trajectory to mo.traj
    logfile="Research_Lab/Na3Zr2Si2PO12/mo_log/mo.log" + str(t),  # log file for MD
