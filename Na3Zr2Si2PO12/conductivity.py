...
for t in temperatures:
    traj = Trajectory("Research_Lab/Na3Zr2Si2PO12/trajectories/mo.traj" + str(t), mode="r")
...
print("The Na ionic conductivity for Na3Zr2Si2PO12 at 300 K is %.4f mS/cm" % rts)