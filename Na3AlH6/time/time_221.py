...
parameters = MolecularDynamics(
    ...
    timestep=1, # 1fs,
    trajectory="Research_Lab/Na3AlH6/time/trajectories/mo.traj" + str(t),  # save trajectory to mo.traj
    logfile="Research_Lab/Na3AlH6/time/mo_log/mo.log" + str(t),  # log file for MD
