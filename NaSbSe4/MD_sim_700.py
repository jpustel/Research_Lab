...
with MPRester(api_key="bl5ZA4p8qFoei37Lo61kGU9Yr0JD6TE5") as mpr:
    data = mpr.get_structure_by_material_id("mp-8703")
...
parameters = MolecularDynamics(
    ...
    timestep=1, # 1fs,
    trajectory="Research_Lab/NaSbSe4/trajectories/mo.traj" + str(t),  # save trajectory to mo.traj
    logfile="Research_Lab/NaSbSe4/mo_log/mo.log" + str(t),  # log file for MD
